...
const WelcomeBlock = () => {
    ...
    ">
        ...
        <p className=" text-gray-400 opacity-40
        text-[15px]/[23px] mt-7
        sm:text-[11px]/[15px]
        md:text-[16px]/[23px] md:mt-9
        xl:text-[24px]/[36px] xl:mt-14
        ">
            Essential software tools for analytics,<br/> visualization, automatization and monitoring.
        </p>

        <button className="flex  text-white   border-solid border-[1px] border-green-100 items-center justify-center gap-5 
